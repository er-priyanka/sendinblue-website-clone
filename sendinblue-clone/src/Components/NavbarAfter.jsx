...
import {GrDocumentText, GrMenu} from "react-icons/gr"
...
export const NavbarAfter = ()=>{
    ...
    return (
        <Flex w="100%" justifyContent="space-around" padding={3} border="1px" bg="#044A75" color="whiteAlpha.700" fontSize="1.1rem"  >
