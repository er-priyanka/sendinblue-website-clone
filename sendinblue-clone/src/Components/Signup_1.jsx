...
export const Signup_1 = ()=>{
    ...
    return (
        <Flex h="100vh" >
            <Box h="100vh" overflowY="scroll" py={10} px={8} >
                ...
                >
                    ...
                    <Text color="gray.600">
                        ...
                        <Link ml="2" color="blue.400" textDecor="underline" _hover={{color:"blue"}}  href="/login">
                        Login</Link>
                    </Text>
                    ...
                    <Button fontSize={{base:"0.9rem", md:"1.1rem"}} gap="4" bg="white" border="1px" borderColor="blue.400">
                        <Icon as={FcGoogle} />
                        Sign in with Google
                    </Button>
                    ...
                    <Text color="gray.600">By Signing up, you are creating a Sendinblue account, and you agree to 
                    Sendinblue's <Link color="blue.400" textDecor="underline">Terms of use</Link> and <Link color="blue.400" textDecor="underline">Privacy Policy</Link>
                    </Text>
            ...
            <Box>
                <Image h="100%" alt="signup_Image" src="https://sendinblue.fra1.digitaloceanspaces.com/fra1.digitaloceanspaces.com/marketing-content-media/register.webp" />
            </Box>    
